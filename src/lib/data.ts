...
export const userWorkouts: Workout[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "e8", name: "Jumping Jacks", sets: 3, duration: 30 },
    ],
    duration: 30,
    date: "2023-11-17",
    isOwner: true,
  ...
  },
  {
    ...
    exercises: [
      { id: "e9", name: "Hamstring Stretch", sets: 3, duration: 30 },
      { id: "e10", name: "Hip Flexor Stretch", sets: 3, duration: 30 },
...
export const communityWorkouts: Workout[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "e18", name: "Warrior Poses", sets: 1, duration: 300 },
      { id: "e19", name: "Balance Poses", sets: 1, duration: 300 },
      { id: "e20", name: "Meditation", sets: 1, duration: 300 },
    ],
    duration: 60,
    date: "2023-11-16",
    isOwner: false,
  ...
  },
  {
    ...
    exercises: [
      { id: "e21", name: "Push-ups", sets: 8, duration: 20 },
      { id: "e22", name: "Sit-ups", sets: 8, duration: 20 },
      { id: "e23", name: "Kettlebell Swings", sets: 8, duration: 20, weight: 35 },
      { id: "e24", name: "Box Jumps", sets: 8, duration: 20 },
    ],
    duration: 25,
    date: "2023-11-13",
    isOwner: false,
  ...
  if (id.startsWith("featured-") || id.startsWith("rec-") || id.startsWith("all-")) {
    return {
      ...
      exercises: [
        ...
        { id: "e3", name: "Plank", sets: 3, duration: 30 },
      ],
      duration: 30,
